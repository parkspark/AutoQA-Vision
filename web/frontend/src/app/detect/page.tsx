...
const SAMPLES: Sample[] = [
  { name: "ScreenShot2024_0304_084801113.jpg", url: "/image/ScreenShot2024_0304_084801113.jpg" },
  { name: "ScreenShot2024_0304_085326839.jpg", url: "/image/ScreenShot2024_0304_085326839.jpg" },
  { name: "ScreenShot2024_0304_090315563.jpg", url: "/image/ScreenShot2024_0304_090315563.jpg" },
  { name: "ScreenShot2024_0304_091035562.jpg", url: "/image/ScreenShot2024_0304_091035562.jpg" },
  { name: "ScreenShot2024_0304_101601331.jpg", url: "/image/ScreenShot2024_0304_101601331.jpg" },
  { name: "ScreenShot2024_0304_115450606.jpg", url: "/image/ScreenShot2024_0304_115450606.jpg" },
];
...
export default function DetectPage() {
  ...
  const [samples] = useState<Sample[]>(SAMPLES);
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-12">
      <header className="mb-8">
        <p className="text-brand text-sm font-medium uppercase tracking-wide mb-2">스크린샷 탐지</p>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-5">
          <label
            ...
            className={`card grid place-items-center text-center p-8 cursor-pointer transition-colors ${dragOver ? "border-brand bg-brand/5" : ""
              }`}
          >
            <input
              type="file"
